NES APU Sweep Tests
-------------------
Tests sweep add/subtract operation for first square channel. Requires
listening to verify operation, since the CPU can't check this. Refer to
recordings for proper output.

The second square's sweep unit isn't yet tested by these, even though it
